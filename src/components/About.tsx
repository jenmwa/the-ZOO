...
export const About = () => {
    ...
    <p className='about-text-left'>Genom att hämta ett API, använda React Router så skulle det gå attb rendera ut djur ochd eras info, samt utifrån när de senast blev matade, få någon visuell feedback och kunna mata igen.</p>
